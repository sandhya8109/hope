...
include('nav.php')
    ?>
<!-- Page Header Start -->
<div class="container-fluid pageabout-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style=" height: 293px;
    width: 100%;">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" style="min-height: 400px;">
                <div class="team-item rounded overflow-hidden pb-4 position-relative h-100">
                    ...
                    <ul class="team-social">
                        <li><a class="btn btn-square" href="https://www.facebook.com/shashi.ray"><i
                                    class="fab fa-facebook-f"></i></a></li>
                        <li><a class="btn btn-square" href="https://www.linkedin.com/in/shashi-ray-1070a262/"><i
...
<a class="btn btn-primary py-3 px-5 mt-2" href="./refer.php" style="margin-left:100px;">Get Started</a>
    ...
    <div class="container">
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        <i class="fa-solid fa fa-3x fa-handshake-angle text-primary mb-4" style="color:#274a84;"></i>
