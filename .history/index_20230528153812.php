    ...
    <div class="container-xxl pt-5">
        <div class="container">
            ...
            <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="project-item mb-5">
                    <div class="position-relative">
                        <img class="img-fluid" src="./assets/img/Volunteer-helping-elderly-scaled.jpg" alt="">
                        <div class="project-overlay">
                            <a class="btn btn-lg-square btn-light rounded-circle m-1"
                                href="./assets/img/Volunteer-helping-elderly-scaled.jpg" data-lightbox="project"><i
                                    class="fa fa-eye"></i></a>
                            <a class="btn btn-lg-square btn-light rounded-circle m-1" href=""><i
                                    class="fa fa-link"></i></a>
                        </div>
