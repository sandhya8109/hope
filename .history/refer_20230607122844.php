                ...
                <form action="referalsend.php" method="POST" id="msform" class="justify-content-center mb-4">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col"><label class="fieldlabels">Date of Birth: </label> <input type="date"
                                        name="birth" id="birth" placeholder="" /></div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label class="fieldlabels">Other names(if applicable): </label> <input type="text"
                                        name="othername" id="othername" placeholder="Other Name" />
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="radio">
                                        ...
                                        <div class="d-flex"><label class="fieldlabels">Both </label> <input type="radio"
                                                name="b" id="b" value="Torres Strait & Aboriginal" />
                                        </div>
                                ...
                                <div class=" col"><label class="fieldlabels">Has the Participant consented to this
                                        referral? </label>
                                    <div class="radio">
                                        <div class="d-flex"><label class="fieldlabels">Yes </label> <input type="radio"
                                                name="y" id="y" /></div>
                                        <div class="d-flex"><label class="fieldlabels">No </label> <input type="radio"
                                                name="n" id="n" /></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <label class="fieldlabels">Communication Status:</label> <input type="text" name="status"
                            ...
                            <label class="fieldlabels">Personal Mobility Aids: </label> <input type="text" name="aids"
                                id="aids" placeholder="Personal Mobility Aids" />
                            ...
                            <div class="checkbox">
                                ...
                                <label class="fieldlabels">Commode </label> <input type="checkbox" name="c" id="c"
                                    value="Commode" />
                                <label class="fieldlabels">Sarah Steady </label> <input type="checkbox" name="s" id="s"
                                    value="Sarah Steady" />
                                <label class="fieldlabels">Any other Assistive Devices </label> <input type="checkbox"
                                    name="any" id="any" value="Any other Assistive Device"
                            ...
                            </label> <textarea id="" name="behavior" id="behavior" row-1="10" cols="50" placeholder="">
                            </textarea>
                            ...
                            <div class="checkbox">
                                <label class="fieldlabels">Yes </label> <input type="checkbox" value="Yes"
                                    name="pbspy" />
                                <label class="fieldlabels">No </label> <input type="checkbox" value="No" name="pbspn" />
                            </div>
                            ...
                            <div class="checkbox">
                                ...
                                <div class="col">
                                    <label class="fieldlabels">Communication assessment </label> <input type="checkbox"
                                        name="ass" id="ass" />
                                    ...
                                    <label class="fieldlabels">Other: </label> <input type="checkbox" id="ot" name="ot"
                                        onclick="OnChangeCheckbox (this)" ID="chkAssociation" />
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="checkbox">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1:1<input type="checkbox" value="1:1"
                                    name="1" id="1" />
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col"><label class="fieldlabels">Plan Start Date: </label> <input type="date"
                                        name="pd" id="pd" placeholder="" /></div>
                                <div class="col"><label class="fieldlabels">Plan End Date: </label> <input type="date"
                                        name="em" id="em" placeholder="" /></div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col"><label class="fieldlabels">Organization: </label> <input type="text"
                                        name="NO" id="NO" placeholder="Organization" /></div>
                            </div>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="col"><label class="fieldlabels">Organization: </label> <input type="text"
                                        name="PMo" id="PMo" placeholder="Organization" /></div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label class="fieldlabels">Email: </label> <input type="email" name="PMe" id="PMe"
                                        placeholder="Email" />
                                </div>
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label class="fieldlabels">Home: </label> <input type="number" name="PPGH" id="PPGH"
                                        value="Home" placeholder="Home" />
                                </div>
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label class="fieldlabels">Organisation: </label> <input type="text" name="O" id="O"
                                        placeholder="Organisation" />
                                </div>
                                <div class="col"><label class="fieldlabels">Name: </label> <input type="text" name="N"
                                        id="N" placeholder="Name" /></div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <label class="fieldlabels">Contact Number: </label> <input type="Number" name="CN"
                                        id="CN" placeholder="Contact" />
                                </div>
                                <div class="col"><label class="fieldlabels">Email: </label> <input type="email" name="E"
                                        if="E" placeholder="Email" /></div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col"><label class="fieldlabels">Date: </label> <input type="date" name="D"
                                        id="D" placeholder="Mobile" /></div>
                            </div>
