...
<body>
  ...
  <!-- Page Header Start -->
  <div class="container-fluid pagemental-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
  ...
  <p class="mb-4">At FDS, we embrace a person-centered approach, placing the individual at the heart of our holistic
    care. We take the time to deeply understand each participant's needs, working together to define and pursue their
    goals for independent living and fulfillment. By collaborating closely with participants, their families, and key
    stakeholders such as the justice and correction services, Top End Mental Health (TEMH), Mental Health Central
    Australia Region (MH-CAR), Adult Guardians and Advocacy Groups we ensure that individuals with disabilities and
    their families receive the comprehensive support they deserve.</p>
  <p class="mb-4">Our dedicated team is committed to empowering participants to live meaningful and independent lives.
  ...
  <div class="content">
    <p>Anxiety disorder is a mental health condition characterized by excessive and persistent fear, worry, and
      apprehension. It can significantly impact daily life and often includes physical symptoms. Various types of
      anxiety disorders exist, such as generalized anxiety disorder, panic disorder, and social anxiety disorder. </p>
  </div>
  <button class="collapsible">Depression </button>
  <div class="content">
    <p>Depression is a mental health disorder characterized by persistent feelings of sadness, loss of interest, and
      changes in sleep, appetite, and energy levels. It can impact thoughts, emotions, and daily functioning.</p>
  </div>
  ...
  <div class="content">
    <p>Post-Traumatic Stress Disorder (PTSD) is a mental health condition that can occur after experiencing or
      witnessing a traumatic event. Symptoms include intrusive memories, avoidance of triggers, negative mood changes,
  ...
  <div class="content">
    <p>Trauma refers to distressing experiences that overwhelm an individual's ability to cope, resulting in
      long-lasting emotional, psychological, and physical effects. It can stem from various sources such as assault,
      disasters, abuse, or witnessing violence. Symptoms of trauma include intrusive memories, avoidance, emotional
      disturbances, and changes in behavior. Adopting a trauma-informed approach involves recognizing trauma's
      prevalence, providing support that promotes safety and empowerment, and utilizing specialized therapies.</p>
  </div>
  <button class="collapsible">Paranoia </button>
  <div class="content">
    <p>Paranoia is a psychological phenomenon characterized by intense and persistent feelings of suspicion, mistrust,
  ...
  <div class="content">
    <p>Schizophrenia is a chronic and severe mental disorder characterized by a combination of positive symptoms
      (hallucinations, delusions) and negative symptoms (diminished emotional expression, reduced motivation). It also
  ...
  <div class="content">
    <p>Bipolar disorder, also known as manic-depressive illness, is a mental health condition characterized by extreme
  ...
  <p class="mb-4">At our organization, we recognize the importance of community reintegration and offer comprehensive
    support and services to assist participants in this process. We provide tailored support that addresses their
    specific needs, such as housing assistance, employment opportunities, educational programs, and access to healthcare
