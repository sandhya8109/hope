      ...
      <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav">
            ...
            <a href="./index.php" class="nav-item nav-link">Work With Us</a>
    ...
    <div class="container py-5">
      ...
      <div class="row g-5">
        <div class="col-lg-3 col-md-6">
          ...
          <p style=" margin:0px;">Hope Ability acknowledges the traditional owners and custodians of country throughout
            Australia
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <a class="btn btn-link" href="./team.html">Work with us</a>
          <style>
            .btn-link {
              margin: 0px;
            }
