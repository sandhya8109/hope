    ...
    <div class="row" style="height: 50rem">
        <div class="col-md-6">
            ...
            <p style="font-size: 1.2rem">We provide assistance with and/or supervising tasks of daily life in a
                shared living environment, which
            ...
            <p style="font-size: 1.2rem">We work under Supported Independent Living (SIL) arrangement to supervise
                your daily life tasks while in
        ...
        <div class="col-md-6">
            <img class="img-fluid" src="background/personal activities.jpeg" alt="Volunteer" width="100%"
                style="height: 80%">
        </div>
    </div>
