                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col"><label class="fieldlabels">Has the Participant consented to this
                                            referral? </label>
                                        <div class="radio">
                                            <div class="d-flex"><label class="fieldlabels">Yes </label> <input
                                                    type="radio" name="y" id="y" /></div>
                                            <div class="d-flex"><label class="fieldlabels">No </label> <input
                                                    type="radio" name="n" id="n" /></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="checkbox">
                                    ...
                                    <div class="d-flex"><label class="fieldlabels">Not applicable </label> <input
                                            type="checkbox" name="nap" id="nap" value="Not Applicable" /></div>
                                </div>
