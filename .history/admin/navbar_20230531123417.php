...
<nav id="sidebar" class='mx-lt-5' >
		<div class="sidebar-list">
				...
				<a href="index.php?page=banner" class="nav-item nav-banner"><span class='icon-field'><i class="fa fa-cogs"></i></span>Add Slider</a>

				<a href="index.php?page=list_banner" class="nav-item nav-list_banner"><span class='icon-field'><i class="fa fa-cogs"></i></span>Manage Slider</a>
