...
<form method="post" action="#" enctype="multipart/form-data">
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <input type="text" name="name" class="form-control form-control-lg" id="title" placeholder="Name" required="">
    </div>
   ...
   <div class="form-group row">
    ...
    <div class="col-sm-8">
    <input type="text" name="descb"  class="form-control form-control-lg" id="descb" placeholder="Description" required="">
    </div>
  </div>
