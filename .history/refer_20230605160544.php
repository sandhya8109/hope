                    ...
                    <form action="referalsend.php" method="POST" id="msform" class="justify-content-center mb-4">
                        ...
                        <fieldset>
                            <div class="form-card">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="radio">
                                            ...
                                            <label class="fieldlabels">Torres Strait </label> <input type="radio"
                                                name="t" id="t" />
                                            <label class="fieldlabels">Both </label> <input type="radio" name="b"
                                                id="b" />
                                ...
                                <div class="checkbox">
                                    <label class="fieldlabels">Hoisting </label> <input type="checkbox" name="h"
                                        id="h" />
                                    <label class="fieldlabels">Commode </label> <input type="checkbox" name="c"
                                        id="c" />
                                    ...
                                    <label class="fieldlabels">Any other Assistive Devices </label> <input
                                        type="checkbox" id="OtherCheckBox" name="any" id="any"
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="checkbox">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1:1<input type="checkbox" name="1"
                                        id="1" />
                                    1:2<input type="checkbox" name="2" id="2" />1:3<input type="checkbox" name="3"
                                        id="3" />
                                    <label class="fieldlabels">Other </label> <input type="text" name="4" id="4" />
                                </div>
                                <div class="checkbox">
                                    <label class="fieldlabels">Night</label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1:1<input type="checkbox" name="5" id="5" />
                                    1:2<input type="checkbox" name="6" id="6" />1:3<input type="checkbox" name="8"
                                        id="8" />
                                    <label class="fieldlabels">Other </label> <input type="text" name="7" height="7" />
                                </div>
                                <div class="checkbox">
                                    <label class="fieldlabels">Community Access </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;1:1<input type="checkbox" name="9" id="9" />
                                    1:2<input type="checkbox" name="10" id="10" />1:3<input type="checkbox" name="11"
                                        id="11" />
                                    <label class="fieldlabels">Other </label> <input type="text" name="12" id="12" />
                                </div>
                                <div class="checkbox">
                                    Passive<input type="checkbox" name="p" id="p" />
                                    Active<input type="checkbox" name="ac" id="ac" /> </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">Hour/time<input type="text" name="hr2" id="Ahr2" placeholder="" />
                                    </div>
                                    <div class="col">
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="checkbox">
                                    <label class="fieldlabels">Yes </label> <input type="checkbox" name="ay" id="ay" />
                                    <label class="fieldlabels">Pending(waiting response) </label> <input type="checkbox"
                                        name="ap" id="ap" />
                                    <label class="fieldlabels">Not commenced </label> <input type="checkbox" name="nc"
                                        id="nc" />
                                    <label class="fieldlabels">Not Applicable </label> <input type="checkbox" name="an"
                                        id="an" />
                                </div>
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"><label class="fieldlabels">Phone: </label> <input type="PMnn"
                                            id="PMnn" name="date" placeholder="Phone" /></div>
                                </div>
                            </div> <input type="button" name="next" class="next action-button" value="Next" /> <input
                                type="button" name="previous" class="previous action-button-previous"
                                value="Previous" />
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <input type="file" name="PPGS" id="PPGS" accept="image/*">
                            </div> <input type="button" name="next" class="next action-button" value="Next" /> <input
                                type="button" name="previous" class="previous action-button-previous"
                                value="Previous" />
                        </fieldset>
                            ...
                            <div class="form-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col"><label class="fieldlabels">Name: </label> <input type="text"
                                            name="number" placeholder="Name" /></div>
                                </div>
                                <div class="row">
                                    <div class="col">
