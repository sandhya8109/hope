...
<form action="referalsend.php" method="post" id="userAccountSetupForm" name="userAccountSetupForm"
    ...
    <div class="user-details">
            ...
            <div class="mt-3">
                ...
                <div class="radio">
                    <ul>
                        ...
                        <label for="" name="hearing">Hearing</label><br>
        ...
        <section id="step-3" class="form-step d-none">
            <h2 class="font-normal">Referred By</h2>
            <!-- Step 3 input fields -->
            <div class="mt-3">
                <label for="first_name" class='required'>First Name </label>
                <input type="text" id="first_name" name="first_name" placeholder="Referrer First Name" />

                <label for="last_name" class='required'> Last Name </label>
                <input type="text" id="last_name" name="last_name" placeholder="Referrer First Name" />
            </div>
            <div class="mt-3">
