...
<body>
   ...
   Spinner End -->
    ...
    <!-- Page Header Start -->
    <div class="container-fluid pageimp-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
    ...
    <div class="container-xxl py-5">
        <h2 class="text-center" style="margin-bottom: 3rem;">Important Documents</h2>
        <div class="container">
                ...
                <div class="col-md-7">
                    <div class="row text-center">
                        <div class="col-md-4" style="padding-bottom: 2rem;">
                            ...
                            <a href="./impdoc/Hope Ability Brochure.pdf" target=”_blank”>
                        ...
                        <div class="col-md-4" style="padding-bottom: 2rem;"><i
                            ...
                            <a href="./impdoc/Hope Ability Participant Handbook.pdf" target=”_blank”>
                                <button class="bg-danger text-light" style="border-color: red;padding: 10px;">Download
                                    Now</button></a>
                        </div>
                        <div class="col-md-4" style="padding-bottom: 2rem;">
                            ...
                            <a href="./impdoc/Privacy-Statement.pdf" target=”_blank”>
                                <button class="bg-danger text-light" style="border-color: red;padding: 10px;">Download
                                    Now</button></a>
                        </div>
                    </div>
