    ...
    <div class="container text-center py-5">
        ...
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0" style="background-color:transparent; color:white;">
                <li class="breadcrumb-item" style="color:#fff;"><a href="./landing.php">Home</a></li>
                <li class="breadcrumb-item" style="color:#fff;"><a href="#">Pages</a></li>
                <li class="breadcrumb-item text-primary" style="color:#fff;" aria-current="page">Referral</li>
            </ol>
        </nav>
    </div>
</header>
