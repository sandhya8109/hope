        ...
        <div class="container-fluid justify-content-center" style="width:90%">
            <div class="row justify-content-center">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3 justify-content-center">
                    ...
                    <form id="msform" action="refera.send.php" method="POST" class="justify-content-center mb-4">
                        <form id="msform" action="referal.send.php" method="POST" class="justify-content-center mb-4">
                            <!-- progressbar -->
                            <ul id="progressbar">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label class="fieldlabels">Participant's Full Name: </label> <input
                                                type="text" name="participantfn"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col"><label class="fieldlabels">Gender: </label> <select
                                                id="drop-down" name="gender">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col"><label class="fieldlabels">Postal Address(if different):
                                            </label>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="radio">
                                                ...
                                                <label class="fieldlabels">Torres Strait </label> <input type="radio"
                                                    name="uname" />
                                                <label class="fieldlabels">Both </label> <input type="radio"
                                                    name="uname" />
                                                <label class="fieldlabels">Neither </label> <input type="radio"
                                                    name="uname" />
                                            </div>
                                        </div>
                                        <div class="col"><label class="fieldlabels">Has the Participant consented to
                                                this
                                                referral? </label>
                                            <div class="radio">
                                                <label class="fieldlabels">Yes </label> <input type="radio"
                                                    name="uname" />
                                                <label class="fieldlabels">No </label> <input type="radio"
                                                    name="uname" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="checkbox">
                                        <label class="fieldlabels">Completed and attached </label> <input
                                    ...
                                    <div class="checkbox">
                                        <label class="fieldlabels">Hoisting </label> <input type="checkbox"
                                            name="Hoisting" />
                                        <label class="fieldlabels">Commode </label> <input type="checkbox"
                                            name="commode" />
                                    ...
                                    <div class="checkbox">
                                        <div class="col">
                                            <label class="fieldlabels">PBSP </label> <input type="checkbox"
                                                name="pbsp" />
                                            ...
                                            <label class="fieldlabels">Risk assessment </label> <input type="checkbox"
                                                name="risk" />
                                            <label class="fieldlabels">Person centered plan </label> <input
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="checkbox">
                                        ...
                                        1:2<input type="checkbox" name="uname" />1:3<input type="checkbox"
                                            name="uname" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">Hour/time<input type="text" name="time" placeholder="" />
                                        </div>
                                        <div class="col">
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label class="fieldlabels">Pending(waiting response) </label> <input
                                            type="checkbox" name="uname" />
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label class="fieldlabels">NDIS Number: </label> <input type="text"
                                                name="name" placeholder="NDIS Number " />
                                        </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col"><label class="fieldlabels">Mobile: </label> <input
                                                type="number" name="number" placeholder="Mobile" /></div>
                                    </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="checkbox">
                                        <label class="fieldlabels">Guardian (completed above,no further details
                                            required)
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label class="fieldlabels">Organisation: </label> <input type="text"
                                                name="name" placeholder="Organisation" />
                                        </div>
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <h2 class="purple-text text-center"><strong>Submitted Successfully !</strong></h2>
                                    <br>
                                    <div class="row justify-content-center">
                                        <div class="col-3"> <img src="./img/icons8-tick-100.png" class="fit-image">
                                        </div>
                                    </div> <br><br>
                                    <div class="row justify-content-center">
