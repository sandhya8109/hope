...
<body>
   ...
   Spinner End -->
    <!-- Page Header Start -->
    <div class="container-fluid pageabout-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">Hope Ability has extensive experience in providing support for individuals with
                        ...
                        requirements. We are a local organization based in Darwin NT and registered with the NDIS. Our
                        mission is to empower people with a disability to engage in opportunities of their choice in a
                        supported and inclusive environment.</p>
                    <p class="mb-4">Our vision is to empower participants to take ownership of their life. We provide
                        services to people of all abilities, backgrounds, preferences, and lifestyles. It is important
                        for us at Hope Ability to not only provide support services that are respectful and offer
                        dignity to participants, but also to create a safe and inclusive working environment for our
                        staff.</p>
                    <p class="mb-4">We have embedded person-centered support in our mission to ensure all staff treat
                        ...
                        an enhanced quality of life. </p>
                    <p class="mb-4">Participants are supported to integrate within their community, with family and
                        friends, in a manner that assists them to meet their goals by having their views and input
                        valued, which is their legal and human right. </p>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p>The company director, Shashi Ray, possesses extensive professional experience of over 15
                        years in the field of Disability, encompassing areas such as Child Protection, Mental
                        Health, and the National Disability Insurance Scheme (NDIS) within Australia and
                        internationally.
                        Shashi has demonstrated a diverse professional background, having resided, and worked in
                        various regions of the Northern Territory in different capacities within the Mental Health
                        and Disability Sector. Shashi has fulfilled roles such as Supervisor for an Out-of-Home Care
                        program with Territory Family, House Supervisor for the Forensic Disability Unit taking care
                        of vulnerable individuals within custodial settings. Additionally, he has served local
                        ...
                        invaluable support to forensic participants in navigating the Justice system, facilitating
                        their transition from custodial settings, and facilitating their successful reintegration
