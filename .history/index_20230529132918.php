...
<table>
	...
	<tr><td>Mobile No.: </td><td>" . $_POST["subject"] . "</td></tr>
                ...
                <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" textarea id="m" placeholder="Leave a message here"
                                        id="m" name="m" style="height: 150px"></textarea>
