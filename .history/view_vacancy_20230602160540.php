										...
										<div class="card-header">
											<div class="row">
												<div class="col-lg-12">
													...
													<button
														class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right"
														type="button" id="new_application"><i class="fa fa-plus"></i>
													...
													<div class="row">
														...
														<div class="col-md-5">
															<select name=""
																...
																id="position_filter">
																<option value="all" <?php echo isset($position_id) && $position_id == "all" ? "selected" : '' ?>>All
																</option>
								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row">
											<div class="col-lg-12">
												<?php if ($status == 1): ?>
													<button class="btn btn-block col-md-4 btn-primary btn-sm float-right"
														type="button" id="apply_now">Apply Now</button>

												<?php else: ?>
													<button class="btn btn-block col-md-4 btn-primary btn-sm float-right"
														type="button" disabled="" id="">Application Closed</button>
												<?php endif; ?>
