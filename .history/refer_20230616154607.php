                    ...
                    <form action="referalsend.php" method="POST" id="msform" enctype="multipart/form-data" class="
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <input name="foo" type="file" id="img" name="img" class="ipdetail"
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-5">Hour/time<input type="text" name="hr1" id="hr1"
                                            class="ipdetail" placeholder="" />
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-5">Hour/time<input type="text" name="hr2" id="hr2"
                                            class="ipdetail" placeholder="" />
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-5">Hour/time<input type="text" name="hr3" id="hr3"
                                            class="ipdetail" placeholder="" />
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-5">Hour/time<input type="text" name="hr4" id="hr4"
                                            class="ipdetail" placeholder="" />
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-5">Hour/time<input type="text" name="hr5" id="hr5"
                                            class="ipdetail" placeholder="" />
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-5">Hour/time<input type="text" name="hr6"
                                            class="ipdetail" id="hr6" placeholder="" />
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 col-md-5">Hour/time<input type="text" name="hr7" id="hr7"
                                            class="ipdetail" placeholder="" />
                                    </div>
                                    <div class="col-sm-6 col-md-5">
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="radio">
                                    ...
                                    <div class="d-flex"><input type="radio" value="Not Commenced" name="ay" id="nc" />
                                        <label>Not commenced </label>
                                    </div>
                                    <div class="d-flex"><input type="radio" value="Not applicable" name="ay" id="an" />
                                        <label>Not Applicable </label>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="radio">
                                    <div class="d-flex"><input type="radio" value="Agency Managed" name="AM" id="AM" />
