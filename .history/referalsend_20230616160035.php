...
$mail->isHTML(true);
$mail->Subject = "Refferal Form Email";
...
<table>
    ...
    <tr><td>Does the Participant identify as:</td><td>" . $_POST["a"] . $_POST["t"] . $_POST["b"] . $_POST["n"] . "</td></tr>
    <tr><td>Has the Participant consented to this
    referral? </td><td>" . $_POST["y"] . $_POST["n"] . "</td></tr>
    ...
    <tr><td>Communication assessment: </td><td>" . $_POST["complete"] . $_POST["not"] . $_POST["nap"] . "</td></tr>
       ...
       <tr><td>Personal Mobility Aids Required: </td><td>" . $_POST["h"] . $_POST["c"] . $_POST["s"] . "</td></tr>
   ...
   <tr><td>Does Participant have a current Behaviour Support Plan(PBSP)?: </td><td>" . $_POST["pbspy"] . $_POST["pbspn"] . "</td></tr>
    <tr><td>Please tick the documents that have been provided: </td><td>" . $_POST["pbsp"] . $_POST["ndis"] . $_POST["risk"] . $_POST["plan"] . "</td></tr>
    <tr><td> Communication assessment </td><td>" . $_POST["ass"] . $_POST["oc"] . $_POST["co"] . $_POST["ot"] . "</td></tr>
    ...
    <tr><td>Coordinator of Supports  (complete referrer details) </td><td>" . $_POST["C"] . "</td></tr>
    <tr><td>Coordinator of Supports: Organization: </td><td>" . $_POST["O"] . "</td></tr>
    <tr><td>Coordinator of Supports: name: </td><td>" . $_POST["N"] . "</td></tr>
    <tr><td>Coordinator of Supports: Phone: </td><td>" . $_POST["CN"] . "</td></tr>
    <tr><td>Coordinator of Supports: Email: </td><td>" . $_POST["E"] . "</td></tr>
    <tr><td>Coordinator of Supports: Postal Address: </td><td>" . $_POST["P"] . "</td></tr>
    <tr><td>Coordinator of Supports: Signature Photo:: </td><td>" . $_POST["SP"] . "</td></tr>
    <tr><td>Primary Diagnosis Document: </td><td>" . $_FILES["foo"]["name"] . "</td></tr>
