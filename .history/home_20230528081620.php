...
<section id="list" style=:"background-color:pink;">
    <div class="container mt-3 pt-2">
        <h1 class="section-title bg-white text-center text-primary px-3">Our
            Current Vacancy</h1>
        <hr class="divider">
            ...
            ?>
                <div class="card vacancy-list" data-id="<?php echo $row['id'] ?>">
                    <div class="card-body">
                        ...
                        <button class="btn" style="background-color:#274ae4; color:#fff;"> Apply Now</button>
                    </div>
                </div>
                <br>
        <?php endwhile; ?>
