...
<table>
    ...
    <tr><td> Communication assessment </td><td>" . $_POST["com, oc,copy,ot"] . "</td></tr>
    <tr><td>Requested ratio of Support:  </td><td>" . $_POST["1:1 , 1:2, 1:3"] . "</td></tr>
    <tr><td>Copy of NDIS plan </td><td>" . $_POST["copy"] . "</td></tr>
    <tr><tdCurrent Community Access/Day Service:  </td><td>" . $_POST["fav_language" . "language"] . "</td></tr>
