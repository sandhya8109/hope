                ...
                <form action="referalsend.php" method="POST" id="msform" class="justify-content-center mb-4">
                        ...
                        <div class="form-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col"><label class="fieldlabels">Date of Birth: </label> <input type="date"
                                        name="date" id="date" placeholder="" /></div>
                            </div>
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="radio">
                                        <label class="fieldlabels">Aboriginal </label> <input type="radio" name="a"
                                            id="a" />
                                        <label class="fieldlabels">Torres Strait </label> <input type="radio" name="t"
                                            id="t" />
                                ...
                                <div class="col"><label class="fieldlabels">Has the Participant consented to this
                                        referral? </label>
                                    <div class="radio">
                                        <label class="fieldlabels">Yes </label> <input type="radio" name="y" id="y" />
                                        <label class="fieldlabels">No </label> <input type="radio" name="n" id="n" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="checkbox">
                                ...
                                <label class="fieldlabels">Any other Assistive Devices </label> <input type="checkbox"
                                    id="OtherCheckBox" name="any" id="any"
                        ...
                        <div class="form-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col"><label class="fieldlabels">Organization: </label> <input type="text"
                                        name="date" placeholder="Organization" /></div>
                            </div>
                            <div class="row">
                                <div class="col">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row">
                                <div class="col">
                                    <label class="fieldlabels">Contact Number: </label> <input type="Number" name="name"
                                        placeholder="Contact" />
                                </div>
