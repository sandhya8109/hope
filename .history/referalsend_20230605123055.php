...
<table>
    ...
    <tr><td>Does Participant have a current Behaviour Support Plan(PBSP)?: </td><td>" . $_POST["religion"] . "</td></tr>
	...
	<tr><td>Does Participant have a current Behaviour Support Plan(PBSP)? </td><td>" .  $_POST["vision"] "</td></tr>
