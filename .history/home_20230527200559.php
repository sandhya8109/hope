...
<header class="masthead">
    ...
    <div class="text-center wow fadeInUp" data-wow-delay="0.3s">
        ...
        <p class="mb-5">At Hope Ability, we are always on the lookout for exceptional staffs who share our passion for
    ...
    <div class="text-center wow fadeInUp" data-wow-delay="0.3s">
        ...
        <h1 class="section-title bg-white text-center text-primary px-3">Current Vacancy</h1>
