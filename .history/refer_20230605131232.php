        ...
        <div class="container text-center py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    ...
                    <li class="breadcrumb-item" aria-current="page">Referzral</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <form id="msform" class="justify-content-center mb-4">
                        ...
                        <fieldset>
                            <div class="form-card">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="fieldlabels">Participant's Full Name: </label> <input type="text"
                                            name="name" placeholder="Participant's Full Name" />
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="fieldlabels">Other names(if applicable): </label> <input
                                            type="text" name="name" placeholder="Other Name" />
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="fieldlabels">Residental Address: </label> <input type="text"
                                            name="name" placeholder="Residental Address" />
                                    </div>
                                    <div class="col"><label class="fieldlabels">Postal Address(if different): </label>
                                        <input type="text" name="text" placeholder="Postal Address" />
                                    </div>
                                </div>
                                <label class="fieldlabels">Contact Number: </label> <input type="number" name="uname"
                                ...
                                </label> <textarea id="" name="" row-1="10" cols="50"
                                    placeholder="Secondary Disability(ies)">
                            </textarea>
                                <label class="fieldlabels">Communication Status:</label> <input type="text" name="uname"
                                ...
                                <div class="checkbox">
                                    ...
                                    <label class="fieldlabels">Any other Assistive Devices </label> <input
                                        type="checkbox" id="OtherCheckBox" name="uname"
                                ...
                                <div class="checkbox">
                                    ...
                                    <label class="fieldlabels">No </label> <input type="checkbox" name="uname" />
                                </div>
                                ...
                                <div class="checkbox">
                                    ...
                                    <div class="col">
                                        ...
                                        <label class="fieldlabels">Other: </label> <input type="checkbox"
                                            id="OtherCheckBox" name="uname" onclick="OnChangeCheckbox (this)"
                                            ID="chkAssociation" />
