    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" style="margin-left:40px;">
                    <p class="mb-4">The company director, Shashi Ray, possesses extensive professional experience of
                        ...
                        internationally.</p>
                    <p class="mb-4">Shashi has demonstrated a diverse professional background, having resided, and
