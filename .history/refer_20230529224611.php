                    ...
                    <section id="step-1" class="form-step">
                        ...
                        <div class="column">
                            <div class="mt-3 input-box">
                                ...
                                <input type="text" id="participantfn" name="participantfn"
                                    placeholder="Enter first name" required />
                            </div>
                            <div class="mt-3 input-box">
                                <label>Last Name<span style="color:red">*</span></label>
                                <input type="text" name="participantln" id="participantln" placeholder="Enter last name"
                                    required />
                            </div>
                        </div>
                        <div class="column">
                            <div class="mt-3 input-box">
                                ...
                                <input type="date" name="participantbirth" id="participantbirth"
                        ...
                        <div class="mt-3">
                            ...
                            <input type="number" name="participantno" id="participantno"
                                placeholder="Enter phone number" required>

                            <label>Email<span style="color:red">*</span></label>
                            <input type="email" name="participantemail" id="participantemail" placeholder="Enter email"
                                required>
                        </div>
                        <div class="mt-3">
