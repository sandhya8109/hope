...
<div class="container-fluid">
    <h1 class="display-5 mb-4" style="font-size:2.5rem; ">Do You Know Someone Who Needs Help To Live Their Best Life?​</h1>
    <p class="text-center">"Know someone who could benefit from our services? Refer them to us and help us make a difference in their lives. Your referral means a lot to us as we strive to extend our reach and provide exceptional support and care to more individuals. Thank you for considering recommending Hope Ability.”</p></br>
    <h2 class="text-center" style="color: #274a84;">Please Fill In The Following Details</h2>
    <p class="text-center">All fields marked with <span style="color: red;">*</span> are required and must be filled.</p>
        ...
        <form id="userAccountSetupForm" name="userAccountSetupForm" enctype="multipart/form-data" method="POST">
            ...
            <section id="step-1" class="form-step">
                ...
                <div class="mt-3 col">
                    ...
                    <option value="">Temporary Visitors</option></select>
                    </div>
                </div>
                </div>
                ...
                <div class="mt-3">
                    <button class="button btn-navigate-form-step" type="button" step_number="2" onclick="return validateForm()">Next</button>
                </div>
            </section>
            ...
            <section id="step-2" class="form-step d-none">
                ...
                <!-- Step 2 input fields -->
                <div class="mt-3">
                <label for="disability" class='required'> Participant Disability<span style="color:red">*</span></label>
            <div class="radio">
              ...
              <input type="checkbox" id="no" name="Autism Spectrum Disorder" value="no"class="checked">
            ...
            <section id="step-3" class="form-step d-none">
                ...
                <div class="row">
                <div class="mt-3 col">
                    <label for="first_name" class='required'>First Name<span style="color:red">*</span> </label>
                    <input type="text" name="first_name" placeholder="Refferer First Name" data-validation="required"/>
                </div>
                <div class="mt-3 col">
                ...
                <div class="mt-3 ">
                    ...
                    <button class="button submit-btn" id="myInput" type="submit" onclick="return validateForm()">Save</button>
                </div>
            </section>
            </div>
        </form>
