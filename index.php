        ...
        <div class="owl-carousel project-carousel wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="project-item mb-5">
                <div class="position-relative">
                    ...
                    <div class="project-overlay">
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href="background/Household task.jpeg"
                            data-lightbox="project"><i class="fa fa-eye"></i></a>
                        <a class="btn btn-lg-square btn-light rounded-circle m-1" href="./service.php"><i
                                class="fa fa-link"></i></a>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control" textarea id="m" required
                                    placeholder="Leave a message here" id="m" name="m" style="height: 150px"></textarea>
