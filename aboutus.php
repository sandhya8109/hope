   ...
   Spinner End -->
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="./assets/img/hope-ability-about.jpg" alt=""
                ...
                <h1 class="mb-4">We Combine Experience And Empathy</h1>
                    ...
                    <p class="mb-4" style="text-align:justify">Our vision is to empower participants to take ownership of their life. We provide
                ...
                <p class="mb-4" style="text-align:justify">We have embedded person-centered support in our mission to ensure all staff treat
                        ...
                        Participants are supported to integrate within their community, with family and
            ...
            <a class="btn btn-primary py-3 px-5" href="./contact.php">Get Started</a>
        </div>
    </div>
    <!-- About End -->
